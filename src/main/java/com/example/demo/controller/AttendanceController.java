...
public class AttendanceController {
	...
	public String punchIn(@RequestParam(required = false) Integer year,
			...
			Model model,
			HttpSession session, Date date1) {
	...
	public String monthlyAttendanceReq(@RequestParam("selectYear") Integer year,
			@RequestParam("selectMonth") Integer month, @RequestParam("user") Integer userId,
			@ModelAttribute AttendanceFormList formList,
			HttpSession session, Model model) {
	...
	public String reject(Integer userId, MonthlyAttendance monthlyAttendance, Model model,
		...
		attendanceService.rejected(formList, userId, year, month);
